package com.victor.gpw.view.test;
...
public class FundTestReportPanel extends javax.swing.JPanel implements ChooseInterface {
    ...
    public FundTestReportPanel(@SuppressWarnings("rawtypes") ViewController controler, TestResult result){
    	this(result.getCompany().getName());
    ...
    private void loadDataResult(TestResult result){
    	...
    	algorithmReportPanelList.add(new AlgorithmReportPanel(this,  (GpwSimulationResult) result.getChoosenResult(), result.getBeningCapital(), true));
    	for(SimulationResult simulationResult: result.getRestResltList()){
    		algorithmReportPanelList.add(new AlgorithmReportPanel(this,  (GpwSimulationResult) simulationResult, result.getBeningCapital(), false));
    	}
    	loadPanels();
    }
	...
	public void select(Object o) {
		if(o instanceof GpwSimulationResult){
			GpwSimulationResult selectedResult=(GpwSimulationResult) o;
			((GpwController) controller).changeChoosenAlgorithm(selectedResult, result.getCompany());
