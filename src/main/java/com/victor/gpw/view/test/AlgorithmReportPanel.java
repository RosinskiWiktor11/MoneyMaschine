...
public class AlgorithmReportPanel extends javax.swing.JPanel {
	...
	private GpwSimulationResult algorithmResult;
    ...
    public AlgorithmReportPanel(ChooseInterface chooseManager, GpwSimulationResult result, BigDecimal startCapital, boolean choosen){
    	this();
    ...
    private void loadData(GpwSimulationResult result, BigDecimal startCapital){
